...
resource "aws_cognito_user_pool_client" "this" {
  ...
  user_pool_id = local.secret["FDP_TFVAR_COGNITO_USER_POOL_ID"]
...
resource "aws_secretsmanager_secret_version" "this" {
  ...
  secret_string = jsonencode({
    FDP_TFVAR_WEB_CLIENT_ID     = aws_cognito_user_pool_client.this.id
    FDP_TFVAR_WEB_CLIENT_SECRET = aws_cognito_user_pool_client.this.client_secret
  })
}
